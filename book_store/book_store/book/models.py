...
class author(models.Model):
    ...
    author_name = models.CharField(max_length=100,blank=False,verbose_name="Yazar Adı") 
    # author_lastname = models.CharField(max_length=100,blank=False,verbose_name="Yazarın Soyadı") 
